...
% find the m-1 roots of the a polynomial that are nearest and inside the
% unit circle, occasionally, due to numerical inaccuracies, you will get
% two roots on the unit circle and at slightly different angles, instead
% of two roots at the same angle and at slightly different amplitudes.
% For this reason we first sort the root magnitudes and take the first m-1,
% then take the n closest of these
